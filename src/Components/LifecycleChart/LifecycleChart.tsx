...
const LifecycleChart: React.FC<LifecycleChartProps> = ({ lifecycleData, viewFilter }: LifecycleChartProps) => {
  ...
  const getPackageColor = (datum: string) => {
    switch (datum) {
      case 'Retired':
        return 'var(--pf-t--global--color--status--danger--100)' /* CODEMODS: original v5 color was --pf-v5-global--danger-color--100 */;
      case 'Support ends within 3 months':
        return 'var(--pf-t--global--color--status--warning--200)' /* CODEMODS: original v5 color was --pf-v5-global--warning-color--100 */;
      case 'Support ends within 6 months':
        return 'var(--pf-t--global--color--status--warning--200)' /* CODEMODS: original v5 color was --pf-v5-global--warning-color--100 */;
      case 'Not installed':
        return 'var(--pf-t--global--color--severity--none--100)' /* CODEMODS: original v5 color was --pf-v5-global--palette--blue-200 */;
      case 'Supported':
        return 'var(--pf-t--global--color--status--success--100)' /* CODEMODS: original v5 color was --pf-v5-global--success-color--100 */;
      case 'Upcoming release':
        return 'var(--pf-t--global--color--nonstatus--teal--300' /* CODEMODS: original v5 color was --pf-v5-global--palette--blue-100 */;
      default:
