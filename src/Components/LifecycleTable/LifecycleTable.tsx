...
const StatusIcon: React.FunctionComponent<{ supportStatus: string }> = ({ supportStatus }) => {
  switch (supportStatus) {
    case 'Supported':
      return (
        <CheckCircleIcon
          color="var(--pf-t--global--color--status--success--100)" /* CODEMODS: original v5 color was --pf-v5-global--success-color--100 */
        />
      );
    case 'Near retirement':
      return (
        <ExclamationTriangleIcon
          color="var(--pf-t--global--color--status--warning--200)" /* CODEMODS: original v5 color was --pf-v5-global--warning-color--100 */
        />
      );
    case 'Retired':
      return (
        <ExclamationCircleIcon
          color="var(--pf-t--global--color--status--danger--100)" /* CODEMODS: original v5 color was --pf-v5-global--danger-color--100 */
        />
      );
    default:
      return null;
